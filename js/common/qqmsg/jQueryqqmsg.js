/*
    弹出信息提示
*/
define(['css/common/qqmsg/msgbox.css'], function () {
    (function($) {
        //动态生成ID
        ...
        function loadingInit(target, options) {
            ...
            if (options.type && options.type != 'loading') {
                ...
                //2013-12-26梅应祥修改如下
                if (options.loadingType == 1) {
                    $loading.appendTo(target).attr("id", layerId + '_loading').empty()
                        .append('<span class="xiucai-qqmsg-layer"  id="mode_tips_v2"><span class="gtl_ico_clear"></span><span class="' + iconCls + '"></span>' +
                            options.msg + '<span class="gtl_end"></span></span>').css('z-index', options.zIndex + 1);
                } else {
                    $loading.appendTo(target).attr("id", layerId + '_loading').empty()
                        .append('<span class="xiucai-qqmsg-layer' + options.loadingType.toString() + '"  id="mode_tips_v2"><span class="gtl_ico_clear"></span><span class="gtl_ico_loading"></span><span class="gtl_end"></span></span>').css('z-index', options.zIndex + 1);
                }
