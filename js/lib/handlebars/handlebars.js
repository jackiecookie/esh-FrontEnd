define("js/lib/handlebars/handlebars", [],
function () {
    var a = function () {
        var a = function () {
            "use strict";
        ...
        j = function (a) {
            ...
            b.prototype = {
                ...
                block: function (a) {
                    ...
                    "helper" === f ? this.helperSexpr(e, c, d) : "simple" === f ? (this.simpleSexpr(e), this.opcode("pushProgram", c), this.opcode("pushProgram", d), this.opcode("emptyHash"), this.opcode("blockValue")) : (this.ambiguousSexpr(e, c, d), this.opcode("pushProgram", c), this.opcode("pushProgram", d), this.opcode("emptyHash"), this.opcode("ambiguousBlockValue")),
                    this.opcode("append")
                },
                hash: function (a) {
                    var b, c, d = a.pairs;
                    ...
                    c = b[1],
                    this.options.stringParams ? (c.depth && this.addDepth(c.depth), this.opcode("getContext", c.depth || 0), this.opcode("pushStringParam", c.stringModeValue, c.type), "sexpr" === c.type && this.sexpr(c)) : this.accept(c),
                ...
                DATA: function (a) {
                    ...
                    for (var b = a.id.parts,
                    c = 0,
                    d = b.length; d > c; c++) this.opcode("lookup", b[c])
                },
                STRING: function (a) {
                ...
                pushParams: function (a) {
                    ...
                    this.options.stringParams ? (b.depth && this.addDepth(b.depth), this.opcode("getContext", b.depth || 0), this.opcode("pushStringParam", b.stringModeValue, b.type), "sexpr" === b.type && this.sexpr(b)) : this[b.type](b)
                },
        ...
        k = function (a, b) {
            ...
            d.prototype = {
                ...
                compile: function (a, b, c, d) {
                    ...
                    var e, f = a.opcodes;
                    this.i = 0;
                    for (var g = f.length; this.i < g; this.i++) e = f[this.i],
                ...
                createFunctionContext: function (a) {
                    ...
                    if (this.isChild || (g = this.compilerInfo() + g), a) return d.push(g),
                ...
                popHash: function () {
                    ...
                    this.options.stringParams && (this.push("{" + a.contexts.join(",") + "}"), this.push("{" + a.types.join(",") + "}")),
                    this.push("{\n    " + a.values.join(",\n    ") + "\n  }")
                },
                ...
                replaceStack: function (a) {
                    ...
                    var j = a.call(this, b);
                    return g ? (e || this.popStack(), d && this.stackSlot--, this.push("(" + f + j + ")")) : (/^stack/.test(b) || (b = this.nextStack()), this.pushSource(b + " = (" + f + j + ");")),
                        b;
                },
                nextStack: function () {
                ...
                setupOptions: function (a, b) {
                    ...
                    this.options.stringParams && (f.push("hashTypes:" + this.popStack()), f.push("hashContexts:" + this.popStack())),
                    d = this.popStack(),
                    e = this.popStack(),
                    (e || d) && (e || (this.context.aliases.self = "this", e = "self.noop"), d || (this.context.aliases.self = "this", d = "self.noop"), f.push("inverse:" + d), f.push("fn:" + e));
                    for (var i = 0; a > i; i++) c = this.popStack(),
                    b.push(c),
                    this.options.stringParams && (h.push(this.popStack()), g.push(this.popStack()));
            ...
            for (var j = "break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield".split(" "), k = d.RESERVED_WORDS = {},
            l = 0, m = j.length; m > l; l++) k[j[l]] = !0;
    ...
    a.registerHelper("gte",
    function (a, b, c) {
        return a >= b ? c.fn(this) : c.inverse(this);
    }),
    a.registerHelper("htmlDecode",
    function (b) {
        var c = document.createElement("div");
        return c.innerHTML = b,
            new a.SafeString(c.innerText || c.textContent);
    }),
    a.registerHelper("compareArrayLength",
    function (a, b, c) {
        return a >= b ? c.fn() : void 0;
    }),
    a.registerHelper("diffStr",
    function (a, b, c) {
        return a !== b ? c.fn(this) : c.inverse(this);
    }),
    a.registerHelper("compare",
    function (a, b, c) {
        return a == b ? c.fn(this) : c.inverse(this);
    }),
    a.registerHelper("orequal",
    function (a, b, c, d) {
        return a == b || a == c ? d.fn(this) : d.inverse(this);
    }),
    a.registerHelper("greater",
    function (a, b, c) {
        return a > b ? c.fn(this) : c.inverse(this);
    }),
    a.registerHelper("uc",
    ...
    var e = function () {
        ...
        right = a[2],
        options = a[3],
        2 == a.length ? (options = a[1], left ? options.fn(this) : options.inverse(this)) : 3 == a.length ? (right = a[1], options = a[2], left == right ? options.fn(this) : options.inverse(this)) : d.call(operator, left, right) ? options.fn(this) : options.inverse(this)
    };
    return a.registerHelper("is", e),
        a;
});