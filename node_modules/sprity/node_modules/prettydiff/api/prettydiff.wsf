    ...
    <job id="main">
        ...
        <script type="text/javascript" src="../prettydiff-min.js">
            ...
            (function () {
                ...
                if (fail === false) {
                    args.api = "wsf";
                    args.braceline = (WScript.Arguments.Name("braceline") === "true" || WScript.Arguments.Name("braceline") === true) ? true : false;
                    args.bracepadding = (WScript.Arguments.Named("bracepadding") === "true" || WScript.Arguments.Named("bracepadding") === true) ? true : false;
                    ...
                    args.cssinsertlines = (WScript.Arguments.Named("cssinsertlines") === "true" || WScript.Arguments.Named("cssinsertlines") === true) ? true : false;
                    ...
                    args.tagname = (WScript.Arguments.Name("tagmerge") === "true" || WScript.Arguments.Name("tagmerge") === true) ? true : false;
                    args.titanium = (WScript.Arguments.Named("topcoms") === "true" || WScript.Arguments.Named("topcoms") === true) ? true : false;
